...
"""
muzo is a general framework for training audio generative models.
...
- [MusicGen](https://arxiv.org/abs/2306.05284), a state-of-the-art
    ...
    For the solver, see `muzo.solvers.musicgen.MusicGenSolver`, and for the model,
    `muzo.models.musicgen.MusicGen`.
...
- [EnCodec](https://arxiv.org/abs/2210.13438), efficient and high fidelity
    ...
    See `muzo.solvers.compression.CompressionSolver`, and `muzo.models.encodec.EncodecModel`.
