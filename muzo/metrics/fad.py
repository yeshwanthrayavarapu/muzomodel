...
from muzo.data.audio import audio_write
from muzo.data.audio_utils import convert_audio
import flashy
import torch
import torchmetrics

from ..environment import muzoEnvironment
...
class FrechetAudioDistanceMetric(torchmetrics.Metric):
    ...
    in frechet_audio_distance installation. This was tested with python 3.10, cuda 11.8, tensorflow 2.12.0.
        ...
        1. Get the code and models following the repository instructions. We used the steps below:
                ...
                # rm -r models
                cd google-research
           Follow the instructions to download the vggish checkpoint. muzo base configuration
           assumes it is placed in the muzo reference dir.
        ...
        3. muzo's FrechetAudioDistanceMetric requires 2 environment variables pointing to the python executable
           and Tensorflow library path from the above installation steps:
            ...
            and the training conda env is named muzo:
            ```
            ...
            # you may need to reactivate the muzo env for this to take effect
            ```
    ...
    def __init__(self, bin: tp.Union[Path, str], model_path: tp.Union[Path, str],
        ...
        self.model_path = muzoEnvironment.resolve_reference_path(model_path)
