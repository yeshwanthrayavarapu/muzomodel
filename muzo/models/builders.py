...
def get_encodec_autoencoder(encoder_name: str, cfg: omegaconf.DictConfig):
    if encoder_name == "seanet":
        ...
        encoder = muzo.modules.SEANetEncoder(**encoder_kwargs)
        decoder = muzo.modules.SEANetDecoder(**decoder_kwargs)
...
def get_debug_compression_model(device="cpu", sample_rate: int = 32000):
    ...
    encoder = muzo.modules.SEANetEncoder(**seanet_kwargs)
    decoder = muzo.modules.SEANetDecoder(**seanet_kwargs)
