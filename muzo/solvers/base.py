...
class StandardSolver(ABC, flashy.BaseSolver):
    ...
    solvers in muzo. It also provides a nice default management of Dora history replay,
    checkpoint management across epoch, and logging configuration.

    muzo solvers must inherit from the StandardSolver and define the methods
    ...
    def get_eval_solver_from_sig(sig: str, dtype: tp.Optional[str] = None,
                                 ...
                                 **kwargs):
        """Mostly a convenience function around muzo.train.get_solver_from_sig,
